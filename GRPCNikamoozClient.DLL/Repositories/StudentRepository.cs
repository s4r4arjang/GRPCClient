...
namespace GRPCNikamoozClient.DLL.Repositories
{
    public class StudentRepository : IStudentRepository
    {
        private readonly GRPCNikamoozClient.DLL.Protos.v1.StudentService.StudentServiceClient _studentServiceClient;
